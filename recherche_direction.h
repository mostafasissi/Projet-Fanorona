...
{
    //cette fonction permet de renvoyer une direction pour une position dont ona une capture possible et cette direction ne doit pas etre deja visité
